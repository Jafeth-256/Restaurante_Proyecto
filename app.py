...
def index(collection):
    if collection not in ["empleados", "clientes", "bebidas", "platos", "proveedores", "pedidos", "mesas", "pagos"]:
...
def add_document(collection):
    if collection == "empleados":
        ...
        data = {
            'cliente_id': ObjectId(request.form['cliente_id']),
            'platos': [
                {
                    'plato_id': ObjectId(request.form['plato_id']),
